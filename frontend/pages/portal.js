    ...
    <Layout>
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <a href="/hrms" className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-xl p-5 border border-blue-500/30 hover:scale-105 transition flex items-center justify-between group">
          ...
          <a href="/ai-assistant" className="bg-gradient-to-r from-green-600/20 to-emerald-600/20 rounded-xl p-5 border border-green-500/30 hover:scale-105 transition flex items-center justify-between group">
